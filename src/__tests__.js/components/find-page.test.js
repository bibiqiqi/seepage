...
describe('<FindPage />', () => {
    it('Renders without crashing', () => {
        shallow(<EditorFindPage galleryFiles={fileObjects} galleryStarting={0} dispatch={dispatch} />);
    });
    it('Renders the Gallery component, if gallery files are being passed in as props', () => {
        const wrapper = shallow(<EditorFindPage galleryFiles={fileObjects} galleryStarting={0} dispatch={dispatch}/>);
    ...
    it('Renders the FindForm component, if gallery files aren\'t being passed in as props', () => {
        const wrapper = shallow(<EditorFindPage galleryFiles={[]} galleryStarting={0} dispatch={dispatch}/>);
